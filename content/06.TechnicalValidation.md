...
As most of the datasets are under continuous development and continually adding plot records, sPlot Open users are encouraged to get in touch with the custodian(s) of the data they are planning to use (custodian names are reported in https://www.idiv.de/sPlot). 
